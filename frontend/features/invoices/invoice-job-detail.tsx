    ...
    <div className="space-y-6">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-4">
          ...
          <p className="font-mono text-sm font-semibold">{String(job.source_order_id ?? '-')}</p>
        </div>
        <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-4">
        ...
        <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-4">
          ...
          <p className={`font-semibold ${status === 'issued' ? 'text-emerald-700' : status === 'failed' ? 'text-red-600' : 'text-zinc-900'}`}>{label(status)}</p>
        </div>
